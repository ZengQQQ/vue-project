...
const routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {path:'/work/workInform/invite',component:()=>import('@/components/workcenter/WorkInformInvitation.vue'),meta:{requiresAuth:false}},
      {path:'/work/workInform/receive',component:()=>import('@/components/workcenter/WorkInformReceive.vue'),meta:{requiresAuth:false}},
