<template>
  <div class="notification-list">
    ...
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="申请加入项目" name="sent">
        <el-main>
          <el-table :data="sendData">
            <el-table-column prop="stallFix.teamFix.t_name" label="负责队伍" width="150"></el-table-column>
            <el-table-column prop="project.p_name" label="项目"></el-table-column>
...
<!-- 
      ...
      <el-tab-pane label="邀请我-加入项目" name="receive">
        <el-main>
          <el-table :data="receiveData">
            <el-table-column prop="stallFix.teamFix.t_name" label="邀请我的队伍" width="150"></el-table-column>
            <el-table-column prop="stallFix.project.p_name" label="相关项目"></el-table-column>
...
async function fetch(data, c_page) {
  ...
  try {
    const res = await baseApi.post('/user/mentorStallMessage', {}, { params: data });
