...
<template>
  ...
  <el-container class="layout-container">
    ...
    <el-aside width="200px">
      ...
      >
        <el-sub-menu index="1">
          ...
          <el-menu-item index="1-1" route="/work/workGround">
            <el-icon>
              <User />
            </el-icon>
            <span>工作广场</span>
        ...
        <el-sub-menu index="2">
          ...
          <el-menu-item index="2-1" route="/team/teamGround">
            <el-icon>
              <User />
            </el-icon>
            <span>组队广场</span>
          ...
          <el-menu-item index="2-3" route="/team/teamInform">
            <el-icon>
              <EditPen />
            </el-icon>
            <span>队伍通知</span>
        ...
        <el-sub-menu index="3">
          ...
          <el-menu-item index="3-2" route="/user/avatar">
            <el-icon>
              <Crop />
            </el-icon>
            <span>更换头像</span>
          </el-menu-item>
          <el-menu-item index="3-3" route="/user/resetPassword">
            <el-icon>
              <EditPen />
            </el-icon>
            <span>重置密码</span>
    ...
    <el-container>
      ...
      <!-- 底部区域 -->
      <el-footer> ©2024 Created by zcq </el-footer>
    </el-container>
  </el-container>
</template>
