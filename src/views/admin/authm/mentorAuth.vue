<template>
  ...
  <div class="table">
    <el-table :data="tableData" stripe>
      ...
      <el-table-column prop="members" label="状态"></el-table-column>
    ...
    <el-dialog title="编辑" v-model="showEditDialog">
      <el-form :model="currentData" label-width="100px">
        <el-form-item label="导师名称">
          <el-input v-model.trim="currentData.name"></el-input>
        </el-form-item>
        <el-form-item label="导师状态">
          <el-switch v-model="currentData.status" active-text="允许" inactive-text="禁止"></el-switch>
        </el-form-item>
      </el-form>
...
// 表格数据
const tableData = ref([
  { account: "admin", name: "孙志春", major: "计算机", status: 1 },
  { account: "admin", name: "孙志春", major: "计算机", status: 1 },
  { account: "admin", name: "孙志春", major: "计算机", status: 1 },
  { account: "admin", name: "孙志春", major: "计算机", status: 1 }
]);
